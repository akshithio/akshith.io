...
export default function InTextCitationComp(props: InTextCitationProps) {
  return (
    <div className="w-full flex justify-center items-center">
      <div
        className={`${passenger.className} border border-dotted flex justify-center items-center border-black p-[12px] w-[95%] my-[24px]`}
      >
        <div>
          {props.type === "book" && (
            <svg
        ...
        <div className="ml-[12px]">
          <h1>
            <span className="text-[#111]">{props.name}</span> |{" "}
