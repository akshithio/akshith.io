...
All of the code is open source, so you can find the entire repository for the website [here](https://github.com/akshithio/akshith.io) and that CLI tool [here](https://github.com/akshithio/adot).
...
<ImageComp
  ...
  alt="The image demonstrates a Figma file for the designs of this website. It is used simply as a placeholder image to demonstrate the component"
