...
export default function HomePage() {
  return (
    <body className="h-screen w-screen overflow-x-hidden overflow-y-hidden bg-[#eee] p-[24px]">
      <div
        className={`${erika.className} flex gap-x-[48px] text-[18px] underline`}
      >
        <a href="/">
          <h1>home</h1>
        </a>
      ...
      <div className="flex w-screen">
          ...
          <div>
            <div className="ml-[136px] mt-[58px]">
              ...
              <div className="mt-[12px] flex">
                ...
                <h1
                  className={`ml-[12px] ${passenger.className} text-[24px] text-[#111]`}
                >
                  Akshith Garapati
                </h1>
              </div>
              ...
              <div
                className={`${duplet.className} mt-[26px] w-[332px] text-[16px] leading-6 text-[#111]`}
              >
                <p>
              ...
              <div className="mt-[24px]">
                <h1 className={`${duplet.className} text-[16px] text-[#999]`}>
                  listening to self control • frank ocean
                </h1>
              </div>
            </div>
          </div>
        ...
        <div className="relative ml-[20%] flex w-[40%] items-center justify-center">
          <h1 className="text-[200px]">🍃</h1>
          <h1
            className={`${erika.className} absolute bottom-[20%] left-[25%] w-[145px] leading-6`}
          >
            note: work in progress because i’m not really sure what to put here?
            got ideas? <span className="underline">pls tell me 🙏</span>
          </h1>
        </div>
      </div>
    </body>
